...
const exteriorAssets = [
  {
    ...
    fileName: "lorton_field_min.glb",
    src: "/assets/exterior/lorton_field_min.glb",
  ...
  },
  {
    ...
    fileName: "louisiana_state_house_min.glb",
    src: "/assets/exterior/louisiana_state_house_min.glb",
  ...
  },
  {
    ...
    fileName: "le_millefiori_min.glb",
    src: "/assets/exterior/le_millefiori_min.glb",
    capabilities: {
      floorExplorer: false
    }
  },
  {
    ...
    fileName: "singer_building_min.glb",
    src: "/assets/exterior/singer_building_min.glb",
  ...
  },
  {
    ...
    fileName: "building_min.glb",
    src: "/assets/exterior/building_min.glb",
  ...
  },
  {
    ...
    fileName: "building_03_min.glb",
    src: "/assets/exterior/building_03_min.glb",
  ...
  },
  {
    ...
    fileName: "building_06_min.glb",
    src: "/assets/exterior/building_06_min.glb",
  ...
  },
  {
    ...
    fileName: "building_brutalist_tricorner_min.glb",
    src: "/assets/exterior/building_brutalist_tricorner_min.glb",
  ...
  },
  {
    ...
    fileName: "school_building_min.glb",
    src: "/assets/exterior/school_building_min.glb",
  ...
  },
  {
    ...
    fileName: "building_no_6_form_tokyo_otemachi_building_pack_min.glb",
    src: "/assets/exterior/building_no_6_form_tokyo_otemachi_building_pack_min.glb",
  ...
  },
  {
    ...
    fileName: "office_building_2 (1)_min.glb",
    src: "/assets/exterior/office_building_2%20(1)_min.glb",
  ...
  },
  {
    ...
    fileName: "residential_building_with_parking_lot_min.glb",
    src: "/assets/exterior/residential_building_with_parking_lot_min.glb",
...
const fullAssets = [
  {
    ...
    fileName: "building__interior_effect_min.glb",
    src: "/assets/full/building__interior_effect_min.glb",
...
const interiorAssets = [
  ...
  },
  {
    ...
    fileName: "top_down_interior_environment_min.glb",
    src: "/assets/interior/top_down_interior_environment_min.glb",
    assignedProjectId: "prishtina-prime-offices",
    viewerMode: "interior-navigation",
    viewerLabel: "Interior Navigation",
    viewerConfig: {
  ...
  },
  {
    ...
    label: "Home Interior",
    fileName: "home_interior_min.glb",
    src: "/assets/interior/home_interior_min.glb",
    assignedProjectId: "lorton-field-estates",
    viewerMode: "interior-navigation",
    viewerLabel: "Interior Navigation",
    viewerConfig: {
...
export const projects = [
  ...
  },
  {
    ...
    fullProjectFlow: {
      type: "separate-files",
      overviewCopy:
        "Start with the stabilized office exterior, then switch between layout, living-scale, and unit-style interiors to round out the asset story.",
      unitAssets: [
        {
          id: "unit-top-down",
          ...
          copy:
            "Top-down plan view for lease and space-planning proof points on the office floors."
        },
        {
          id: "unit-living-scene",
          label: "Living Interior",
          assetId: "asset-interior-scene-living",
          copy:
            "A softer furnished moment to show how premium fitted space can read beyond raw floorplates."
        },
        {
          id: "unit-residence",
          label: "Residence Demo",
          assetId: "asset-smart-home-apartment",
          copy:
            "Compact unit-level reference for investor conversations about residential-quality fit-out in a CBD office context."
        }
      ]
    },
  ...
  },
  {
    ...
    fullProjectFlow: {
      type: "separate-files",
      overviewCopy:
        "Review the mid-rise shell first, then open interior references for unit scale, lifestyle, and office-style planning.",
      unitAssets: [
        {
          id: "unit-residence",
          label: "Residence Demo",
          assetId: "asset-smart-home-apartment",
          copy: "Unit-scale reference for mixed-use residential floors above the podium prototype."
        },
        {
          id: "unit-living-scene",
          label: "Living Interior",
          assetId: "asset-interior-scene-living",
          copy: "Authored living space to humanize the envelope before underwriting hardens."
        },
        {
          id: "unit-top-down",
          label: "Top-Down Interior",
          assetId: "asset-top-down-interior",
          copy: "Plan-view interior for desk count, cores, and circulation conversations."
        }
      ]
    },
  ...
  },
  {
    ...
    fullProjectFlow: {
      type: "separate-files",
      overviewCopy:
        "Anchor the block on the map with the exterior massing, then walk interiors that show residential and hospitality depth.",
      unitAssets: [
        {
          id: "unit-residence",
          label: "Residence Demo",
          assetId: "asset-smart-home-apartment",
          copy: "Apartment-scale preview for Adriatic-facing residential stacks above the podium."
        },
        {
          id: "unit-living-scene",
          label: "Living Interior",
          assetId: "asset-interior-scene-living",
          copy: "Lived-in coastal interior tone to pair with the waterfront block narrative."
        },
        {
          id: "unit-restaurant-scene",
          label: "Restaurant Interior",
          assetId: "asset-restaurant-interior",
          copy: "Ground-floor F&B atmosphere for retail and activation along the strip."
        }
      ]
    },
  ...
  },
  {
    ...
    fullProjectFlow: {
      type: "separate-files",
      overviewCopy:
        "Use the harbor office shell for silhouette, then compare plan, living, and unit interiors for tenant-fit conversations.",
      unitAssets: [
        {
          id: "unit-top-down",
          label: "Top-Down Interior",
          assetId: "asset-top-down-interior",
          copy: "Plan-level reference for floor efficiency and services core placement."
        },
        {
          id: "unit-living-scene",
          label: "Living Interior",
          assetId: "asset-interior-scene-living",
          copy: "Premium interior mood for services-led harbor employment growth."
        },
        {
          id: "unit-residence",
          label: "Residence Demo",
          assetId: "asset-smart-home-apartment",
          copy: "Compact fitted-space analogy for executive suites or residential-over-office options."
        }
      ]
    },
  ...
  },
  {
    ...
    fullProjectFlow: {
      type: "separate-files",
      overviewCopy:
        "Let the iconic exterior carry first impact, then layer hospitality and unit-scale interiors behind the design story.",
      unitAssets: [
        {
          id: "unit-living-scene",
          label: "Living Interior",
          assetId: "asset-interior-scene-living",
          copy: "Residential-quality interior moment balancing the bold shell geometry."
        },
        {
          id: "unit-restaurant-scene",
          label: "Restaurant Interior",
          assetId: "asset-restaurant-interior",
          copy: "Activated base programming reference for mixed-use at the tricorner."
        },
        {
          id: "unit-residence",
          label: "Residence Demo",
          assetId: "asset-smart-home-apartment",
          copy: "Tower unit preview for investors calibrating yield to iconic architecture."
        }
      ]
    },
  ...
  },
  {
    ...
    fullProjectFlow: {
      type: "separate-files",
      overviewCopy:
        "Start with the campus massing, then show spatial and community-scale interiors alongside a residential reference.",
      unitAssets: [
        {
          id: "unit-home-interior",
          label: "Home Interior",
          assetId: "asset-home-interior",
          copy: "Suburban residential reference for staff housing and community-adjacent programs."
        },
        {
          id: "unit-living-scene",
          label: "Living Interior",
          assetId: "asset-interior-scene-living",
          copy: "Shared learning and social spaces rendered as a warm interior environment."
        },
        {
          id: "unit-top-down",
          label: "Top-Down Interior",
          assetId: "asset-top-down-interior",
          copy: "Plan-view layout for circulation, classrooms, and shared blocks at scale."
        }
      ]
    },
  ...
  },
  {
    ...
    fullProjectFlow: {
      type: "separate-files",
      overviewCopy:
        "Compare the reference tower massing to interior planning, living-scale fit-out, and unit-level density.",
      unitAssets: [
        {
          id: "unit-top-down",
          label: "Top-Down Interior",
          assetId: "asset-top-down-interior",
          copy: "CBD floorplate and core logic for comparables against other office pins."
        },
        {
          id: "unit-living-scene",
          label: "Living Interior",
          assetId: "asset-interior-scene-living",
          copy: "Premium interior tone when the conversation moves beyond shell-to-yield."
        },
        {
          id: "unit-residence",
          label: "Residence Demo",
          assetId: "asset-smart-home-apartment",
          copy: "Unit-scale density reference for residential-over-office or executive-suite analogies."
        }
      ]
    },
  ...
  },
  {
    ...
    fullProjectFlow: {
      type: "separate-files",
      overviewCopy:
        "Lead with the plaza envelope, then open plan, living, and unit interiors for a fuller capital story.",
      unitAssets: [
        {
          id: "unit-top-down",
          label: "Top-Down Interior",
          assetId: "asset-top-down-interior",
          copy: "Financial-floor planning reference for trading density and core placement."
        },
        {
          id: "unit-living-scene",
          label: "Living Interior",
          assetId: "asset-interior-scene-living",
          copy: "Institutional-grade interior mood for anchor-tenant and premium-fit dialogue."
        },
        {
          id: "unit-residence",
          label: "Residence Demo",
          assetId: "asset-smart-home-apartment",
          copy: "Compact unit analogy for mezzanine residential or executive suite overlays."
        }
      ]
    },
  ...
  },
  {
    ...
    fullProjectFlow: {
      type: "separate-files",
      overviewCopy:
        "Show the podium residential massing first, then switch into unit, living, and F&B interiors for the full product stack.",
      unitAssets: [
        {
          id: "unit-residence",
          label: "Residence Demo",
          assetId: "asset-smart-home-apartment",
          copy: "Typical unit preview for boulevard residential above parking and retail."
        },
        {
          id: "unit-living-scene",
          label: "Living Interior",
          assetId: "asset-interior-scene-living",
          copy: "Interior warmth for buyers bridging from podium parking logic to tower life."
        },
        {
          id: "unit-restaurant-scene",
          label: "Restaurant Interior",
          assetId: "asset-restaurant-interior",
          copy: "Street-level activation reference for podium retail and resident amenities."
        }
      ]
    },
  ...
  },
  {
    ...
    fullProjectFlow: {
      type: "separate-files",
      overviewCopy:
        "Use district massing on the map for phasing, then open interior files that show the lived product behind the masterplan.",
      unitAssets: [
        {
          id: "unit-residence",
          label: "Residence Demo",
          assetId: "asset-smart-home-apartment",
          copy: "District-scale residential proof point for phase-one housing envelopes."
        },
        {
          id: "unit-living-scene",
          label: "Living Interior",
          assetId: "asset-interior-scene-living",
          copy: "Hospitality-forward interior for strand-facing residential and resort adjacency."
        },
        {
          id: "unit-restaurant-scene",
          label: "Restaurant Interior",
          assetId: "asset-restaurant-interior",
          copy: "Waterfront dining and amenity programming reference for mixed phases."
        }
      ]
    },
