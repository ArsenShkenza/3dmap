...
export const assetLibrary = [
  ...
  },
  {
    ...
    floorExplorer: {
      mode: "slice",
      supportedModes: ["namedNodes", "slice"],
...
export const projects = [
  ...
  },
  {
    ...
    floorExplorer: {
      ...
      pilotObject: true,
      contract:
        "Prefer named floor groups such as floor_01, floor_02, floor_03. Until a floor-authored export is available, the app uses controlled vertical slice focus for each level.",
